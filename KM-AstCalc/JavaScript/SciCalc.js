$("document").ready(function () {
    ...
    theUnits.set('lb',[['pound',labls[4],'&',lablext[5]],['k,g',0.43559237,0.0,1]]);
    theUnits.set('@',[['arroba',labls[4],'@',lablext[5]],['lb',25.0,0.0,1]]);
    ...
    theUnits.set('oz',[['ounce','Volume','Z',lablext[1]],['m,L',28.4130625,0,1]]);
...
//            console.log(cmbUns.style.backgroundColor);
    ...
    function tdms(X) {
        ...
        let rv = Number(DD).toString() + ":" + Number(MM).toFixed(0).toString() + ":" + Number(S).toFixed(nPrecDigts);
        if (sgn < 0)
            rv = "-" + rv;
        return rv;
    }
    ...
    function setOpek() {
        ...
        fkeys.set('jul', [["JulD", "From Greg. date: day:month:year from Units: [dy].[mth].[yr] get Julian date; 'j'"], ["GrgD", "From Julian date get Gregorian date: day:month:year; 'j'"]]);
    ...
    function gregorian2julianday(gD) {
        ...
        if ((gD[2] < 1582) || 
                (gD[2] === 1582) && ((gD[1] < 10) 
                || ((gD[1] === 10) && (gD[0] < 15)))) {
            if((gD[2] === 1582) && (gD[1] === 10) && (gD[0] < 15) && (gD[0]>4)) gD[0]=4;
            b = 0;
        } else
...
//        var h = 0.001;
        return function (x) {
            if(e > 1)
                return 1.0 - e * Math.cosh(x);
            else
                return 1.0 - e * Math.cos(x);
